...
def agregar():
    ...
    try:
        ...
        if conexion.is_connected():
            ...
            domicilio1 = input("Ingrese el domicilio: ")
            email1 = input("Ingrese el email: ")
            print("Conexión existosa.")
            cursor = conexion.cursor()
...
def editar():
    try:
        ...
        if conexion.is_connected():
            ...
            nombre1 = input("Ingrese el nuevo nombre: ")
            dni1 = int(input("Ingrese el nuevo dni: "))
            domicilio1 = input("Ingrese el nuevo domicilio: ")
            email1 = input("Ingrese el nuevo email: ")
...
def eliminar():
    ...
    dni_nuevo = int(input("Número de DNI a eliminar: "))
    try:
        conexion = mysql.connector.connect(
            host="localhost",
            port='3306',
